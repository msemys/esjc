...
import lt.msemys.esjc.operation.AccessDeniedException;
...
import lt.msemys.esjc.proto.EventStoreClientMessages.*;
import lt.msemys.esjc.proto.EventStoreClientMessages.PersistentSubscriptionNakEvents.NakAction;
...
public class PersistentSubscriptionOperation extends AbstractSubscriptionOperation<PersistentSubscriptionChannel> implements PersistentSubscriptionProtocol {
    ...
    protected PersistentSubscriptionChannel createSubscription(long lastCommitPosition, Integer lastEventNumber) {
        return new PersistentSubscriptionChannel(this, lastCommitPosition, lastEventNumber, streamId);
    }
