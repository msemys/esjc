...
import com.github.msemys.esjc.proto.EventStoreClientMessages.ReadStreamEventsCompleted.ReadStreamResult;
...
public class ReadStreamEventsForwardOperation extends AbstractOperation<StreamEventsSlice, ReadStreamEventsCompleted> {
    ...
    public ReadStreamEventsForwardOperation(CompletableFuture<StreamEventsSlice> result,
                                            String stream,
        ...
        super(result, TcpCommand.ReadStreamEventsForward, TcpCommand.ReadStreamEventsForwardCompleted, userCredentials);
        this.stream = stream;
    ...
    private static SliceReadStatus asSliceReadStatus(ReadStreamResult result) {
        switch (result) {
            case Success:
